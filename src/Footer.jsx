    ...
    <div>
      <div className="bg-gray-700 p-3 space-y-10 md:grid grid-cols-2 md:-mt-6 lg:grid-cols-4">
        <div className="w-1/2 md:ml-24 md:mt-9 md:w-3/4">
          ...
          <p className="text-gray-300/80 text-base hover:text-yellow-300 cursor-none">
            {" "}
            A123 Lost Street <br /> Chandigarh, PB 535022 <br /> India{" "}
          </p>{" "}
          <br />
          <p className="text-gray-200/80 text-base hover:text-yellow-300 cursor-pointer">
            {" "}
            <strong className="tracking-wide text-orange-400 font-normal">
              Phone:
            </strong>{" "}
            +91 7008090111{" "}
          </p>
        ...
        <div className="leading-9 md:w-2/4 md:order-3 md:ml-24">
          <h1 className="text-orange-400 text-xl font-medium tracking-[0.030rem]">
            {" "}
            Useful Links{" "}
          </h1>
          <ul className="mt-2 text-gray-300/80">
            <li>
              {" "}
              <i className="fa fa-chevron-right text-orange-400"></i>{" "}
        ...
        <div className="md:order-2 lg:order-last">
          ...
          <br />
          <p className="text-gray-300/80 w-3/5 leading-7 mb-5 md:w-3/4">
            {" "}
          ...
          <input
            ...
            className="py-1 px-2 placeholder-gray-400 rounded-tl-xl focus: outline-none focus:border border-orange-600 md:w-1/2 lg:w-3/5"
          />
          <button className="text-white bg-orange-400 p-1 -translate-x-1 rounded-br-xl hover:bg-orange-500">
            {" "}
            Subscribe
          </button>
        </div>
      ...
      <div className="bg-gray-900 p-3 flex flex-col text-center pt-5 space-y-8 md:flex-row md:justify-between md:space-y-0">
        <div className="flex mx-3 justify-between space-x-20 md:flex-row text-gray-200 md:space-x-28 md:ml-20 lg:ml-24 lg:space-x-[13rem] xl:space-x-72 xl:ml-24">
          ...
          <p>
            Designed by <span className="text-orange-400">**************</span>
          </p>
        </div>
